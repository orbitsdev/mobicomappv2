...
class FillInTheBlankQuestion {
  ...
  FillInTheBlankQuestion copyWith({
    int? id,
    String? question,
    int? question_number,
    String? correct_answer,
  ...
  factory FillInTheBlankQuestion.fromMap(Map<String, dynamic> map) {
    return FillInTheBlankQuestion(
  ...
  factory FillInTheBlankQuestion.fromJson(String source) => FillInTheBlankQuestion.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'FillInTheBlankQuestion(id: $id, question: $question, question_number: $question_number, correct_answer: $correct_answer)';
  }

  @override
  bool operator ==(covariant FillInTheBlankQuestion other) {
